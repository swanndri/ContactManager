...
/**  
 * Class for sorting by first name.
 */
public class firstNameSort implements Comparator<Contact>{
	...
	public int compare(Contact contact1, Contact contact2) {
		...
		int result = String.CASE_INSENSITIVE_ORDER.compare(contact1.getName().getFirstName(), contact2.getName().getFirstName()); // Compare first names
		return result;
	}
}
